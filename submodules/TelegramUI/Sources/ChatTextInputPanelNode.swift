...
//                    self.menuButtonIconNode.enqueueState(.close, animated: true)
            ...
            if self.theme !== interfaceState.theme {
                ...
                let squareStyle = interfaceState.theme.squareStyle
                
                self.textInputBackgroundNode.image = squareStyle ? textInputRectBackgroundImage(backgroundColor: backgroundColor, inputBackgroundColor: nil, strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor, size: CGSize(width: minimalInputHeight, height: minimalInputHeight), cornerRadius: 4, strokeWidth: strokeWidth) : textInputCircleBackgroundImage(backgroundColor: backgroundColor, inputBackgroundColor: nil, strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor, diameter: minimalInputHeight, strokeWidth: strokeWidth)
                
                self.transparentTextInputBackgroundImage = squareStyle ? textInputRectBackgroundImage(backgroundColor: nil, inputBackgroundColor: interfaceState.theme.chat.inputPanel.inputBackgroundColor, strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor, size: CGSize(width: minimalInputHeight, height: minimalInputHeight), cornerRadius: 4, strokeWidth: strokeWidth) : textInputCircleBackgroundImage(backgroundColor: backgroundColor, inputBackgroundColor: nil, strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor, diameter: minimalInputHeight, strokeWidth: strokeWidth)
                
                self.textInputContainerBackgroundNode.image = squareStyle ? generateStretchableFilledRectImage(size: CGSize(width: minimalInputHeight, height: minimalInputHeight), cornerRadius: 4, color: interfaceState.theme.chat.inputPanel.inputBackgroundColor) : generateStretchableFilledCircleImage(diameter: minimalInputHeight, color: interfaceState.theme.chat.inputPanel.inputBackgroundColor)
