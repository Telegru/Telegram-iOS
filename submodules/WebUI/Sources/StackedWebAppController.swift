...
public final class StackedWebAppController: ViewController, AttachmentContainable {
    ...
    fileprivate class Node: ViewControllerTracingNode, WKNavigationDelegate, WKUIDelegate, ASScrollViewDelegate {
        private weak var controller: StackedWebAppController?
        ...
        init(context: AccountContext, controller: StackedWebAppController) {
        ...
        func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
            ...
            controller.navigationBar?.alpha = 1.0
            transition.updateAlpha(node: self.headerBackgroundNode, alpha: 1.0)
            ...
            if let fullscreenControls = self.fullscreenControls {
            ...
            if let webView = self.webView {
                ...
                if let controller = self.controller {
                    ...
                    let contentInsetsData = "{top:0.0, bottom:0.0, left:0.0, right:0.0}"
...
//                            controller?.dismiss()
    ...
    public var mediaPickerContext: AttachmentMediaPickerContext? {
        return StackedWebAppPickerContext(controller: self)
    }
...
final class StackedWebAppPickerContext: AttachmentMediaPickerContext {
    private weak var controller: StackedWebAppController?
    ...
    init(controller: StackedWebAppController) {
        self.controller = controller
    }
